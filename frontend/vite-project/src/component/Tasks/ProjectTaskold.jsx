...
const ProjectTasks = ({ 
  ...
  // Update TaskCard component definition
  const TaskCard = ({ task, onEdit, onDelete, projectMembers, canAssignTasks }) => {
  ...
  const handleTasksGenerated = async (newTasks) => {
    try {
      ...
      console.error('Error fetching tasks:', error);
      setError('Failed to refresh tasks after generation');
    }
  };
