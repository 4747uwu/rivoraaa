...
/**
 * @desc    Get all teams for current user (owned and member of)
 * @route   GET /api/teams
 * @access  Private
 */
...
/**
 * @desc    Search available connections to add to team
 * @route   GET /api/teams/:teamId/available-connections
 * @access  Private (Owner only)
 */
