...
//     const { tokens } = await client.getToken(code); // Simplified call using configured client
...
//             await user.updateOne({authProvider: "google", isVerified: true});

//             if(!user.profilePicture){
//                 await user.updateOne({profilePicture: payload.picture});
//             }
